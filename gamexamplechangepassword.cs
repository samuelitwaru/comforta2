...
namespace GeneXus.Programs {
   public class gamexamplechangepassword : GXHttpHandler
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202491315542377", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexamplechangepassword.js", "?202491315542380", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E120O2","iparms":[{"av":"AV12UserPasswordNew","fld":"vUSERPASSWORDNEW"},{"av":"AV13UserPasswordNewConf","fld":"vUSERPASSWORDNEWCONF"},{"av":"AV11UserPassword","fld":"vUSERPASSWORD"},{"av":"AV6IDP_State","fld":"vIDP_STATE","hsh":true}]}""");
         setEventMetadata("'LOGIN'","""{"handler":"E130O2","iparms":[]}""");
         return  ;
      }

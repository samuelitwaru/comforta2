   ...
   public class addagbsuppliers : GXDataArea
   {
      ...
      protected void WB2O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsertagbsupplier_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(35), 2, 0)+","+"null"+");", "Add", bttBtninsertagbsupplier_Jsonclick, 5, "Add new item", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERTAGBSUPPLIER\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_AddAgbSuppliers.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START2O2( )
      {
         ...
         Form.Meta.addItem("description", "Add AGB Suppliers", 0) ;
         context.wjLoc = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024912632154", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("addagbsuppliers.js", "?2024912632156", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      protected void StartGridControl35( )
      {
         if ( GridsContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Supplier_Agb Id") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Add AGB Suppliers";
         subGrids_Rows = 0;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRIDS_nFirstRecordOnPage"},{"av":"GRIDS_nEOF"},{"av":"AV18LocationAGBSuppliersSDTs","fld":"vLOCATIONAGBSUPPLIERSSDTS","grid":35},{"av":"nGXsfl_35_idx","ctrl":"GRID","prop":"GridCurrRow","grid":35},{"av":"nRC_GXsfl_35","ctrl":"GRIDS","prop":"GridRC","grid":35},{"av":"subGrids_Rows","ctrl":"GRIDS","prop":"Rows"},{"av":"dynavLocationoption"},{"av":"AV19LocationOption","fld":"vLOCATIONOPTION","pic":"ZZZ9"}]}""");
         setEventMetadata("GRIDS.LOAD","""{"handler":"E152O2","iparms":[]""");
         setEventMetadata("GRIDS.LOAD",""","oparms":[{"av":"AV34UDelete","fld":"vUDELETE"}]}""");
         setEventMetadata("'DOBACK'","""{"handler":"E112O2","iparms":[]}""");
         setEventMetadata("ENTER","""{"handler":"E122O2","iparms":[{"av":"AV18LocationAGBSuppliersSDTs","fld":"vLOCATIONAGBSUPPLIERSSDTS","grid":35},{"av":"nGXsfl_35_idx","ctrl":"GRID","prop":"GridCurrRow","grid":35},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_35","ctrl":"GRIDS","prop":"GridRC","grid":35},{"av":"dynavLocationoption"},{"av":"AV19LocationOption","fld":"vLOCATIONOPTION","pic":"ZZZ9"},{"av":"AV48Customer","fld":"vCUSTOMER"},{"av":"GRIDS_nEOF"},{"av":"subGrids_Rows","ctrl":"GRIDS","prop":"Rows"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV48Customer","fld":"vCUSTOMER"},{"av":"AV18LocationAGBSuppliersSDTs","fld":"vLOCATIONAGBSUPPLIERSSDTS","grid":35},{"av":"nGXsfl_35_idx","ctrl":"GRID","prop":"GridCurrRow","grid":35},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_35","ctrl":"GRIDS","prop":"GridRC","grid":35}]}""");
         setEventMetadata("'DOINSERTAGBSUPPLIER'","""{"handler":"E132O2","iparms":[{"av":"AV31SupplierAGBOptions","fld":"vSUPPLIERAGBOPTIONS"},{"av":"AV18LocationAGBSuppliersSDTs","fld":"vLOCATIONAGBSUPPLIERSSDTS","grid":35},{"av":"nGXsfl_35_idx","ctrl":"GRID","prop":"GridCurrRow","grid":35},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_35","ctrl":"GRIDS","prop":"GridRC","grid":35},{"av":"GRIDS_nEOF"},{"av":"subGrids_Rows","ctrl":"GRIDS","prop":"Rows"},{"av":"dynavLocationoption"},{"av":"AV19LocationOption","fld":"vLOCATIONOPTION","pic":"ZZZ9"}]""");
         setEventMetadata("'DOINSERTAGBSUPPLIER'",""","oparms":[{"av":"AV18LocationAGBSuppliersSDTs","fld":"vLOCATIONAGBSUPPLIERSSDTS","grid":35},{"av":"nGXsfl_35_idx","ctrl":"GRID","prop":"GridCurrRow","grid":35},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_35","ctrl":"GRIDS","prop":"GridRC","grid":35},{"av":"AV31SupplierAGBOptions","fld":"vSUPPLIERAGBOPTIONS"}]}""");
         setEventMetadata("VUDELETE.CLICK","""{"handler":"E162O2","iparms":[{"av":"AV18LocationAGBSuppliersSDTs","fld":"vLOCATIONAGBSUPPLIERSSDTS","grid":35},{"av":"nGXsfl_35_idx","ctrl":"GRID","prop":"GridCurrRow","grid":35},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_35","ctrl":"GRIDS","prop":"GridRC","grid":35},{"av":"GRIDS_nEOF"},{"av":"subGrids_Rows","ctrl":"GRIDS","prop":"Rows"},{"av":"dynavLocationoption"},{"av":"AV19LocationOption","fld":"vLOCATIONOPTION","pic":"ZZZ9"}]""");
         setEventMetadata("VUDELETE.CLICK",""","oparms":[{"av":"AV18LocationAGBSuppliersSDTs","fld":"vLOCATIONAGBSUPPLIERSSDTS","grid":35},{"av":"nGXsfl_35_idx","ctrl":"GRID","prop":"GridCurrRow","grid":35},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_35","ctrl":"GRIDS","prop":"GridRC","grid":35}]}""");

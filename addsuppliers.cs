...
namespace GeneXus.Programs {
   public class addsuppliers : GXDataArea
   {
      ...
      protected void START2H2( )
      {
         ...
         Form.Meta.addItem("description", "Add Suppliers", 0) ;
         context.wjLoc = "";
      ...
      protected void E112H2( )
      {
         ...
         AV14WizardStep.gxTpr_Title = "AGB Suppliers";
         AV14WizardStep.gxTpr_Description = "AGB Suppliers";
         AV13WizardSteps.Add(AV14WizardStep, 0);
         AV14WizardStep = new GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(context);
         AV14WizardStep.gxTpr_Code = "Step2";
         AV14WizardStep.gxTpr_Title = "Generic Suppliers";
         AV14WizardStep.gxTpr_Description = "Generic Suppliers";
         AV13WizardSteps.Add(AV14WizardStep, 0);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249126313679", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("addsuppliers.js", "?20249126313679", false, true);

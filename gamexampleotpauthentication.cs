...
namespace GeneXus.Programs {
   public class gamexampleotpauthentication : GXHttpHandler
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202491315543380", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexampleotpauthentication.js", "?202491315543384", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E120Q2","iparms":[{"av":"AV7AuthenticationTypeName","fld":"vAUTHENTICATIONTYPENAME","hsh":true},{"av":"AV16UseTwoFactorAuthentication","fld":"vUSETWOFACTORAUTHENTICATION","hsh":true},{"av":"AV10IDP_State","fld":"vIDP_STATE"},{"av":"AV14UserName","fld":"vUSERNAME","hsh":true},{"av":"AV15UserPassword","fld":"vUSERPASSWORD"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV10IDP_State","fld":"vIDP_STATE"},{"av":"AV15UserPassword","fld":"vUSERPASSWORD"}]}""");
         setEventMetadata("'LOGIN'","""{"handler":"E130Q2","iparms":[{"av":"AV10IDP_State","fld":"vIDP_STATE"}]""");

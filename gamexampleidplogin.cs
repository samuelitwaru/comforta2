   ...
   public class gamexampleidplogin : GXHttpHandler
   {
      ...
      protected void WB0U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbforgotpwd_Internalname, context.GetMessage( "GAM_Forgotyourpassword", ""), "", "", lblTbforgotpwd_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110u1_client"+"'", "", "TextBlock", 7, "", lblTbforgotpwd_Visible, 1, 0, 0, "HLP_GAMExampleIDPLogin.htm");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavKeepmeloggedin_Internalname, StringUtil.BoolToStr( AV17KeepMeLoggedIn), "", "", chkavKeepmeloggedin.Visible, chkavKeepmeloggedin.Enabled, "true", context.GetMessage( "GAM_Keepmeloggedin", ""), StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(47, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,47);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202491315561386", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexampleidplogin.js", "?202491315561391", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDAUTHTYPES.LOAD","""{"handler":"E170U2","iparms":[{"av":"divTblexternalsauth_Visible","ctrl":"TBLEXTERNALSAUTH","prop":"Visible"}]""");
         ...
         setEventMetadata("VLOGONTO.CLICK","""{"handler":"E120U2","iparms":[{"av":"AV18Language","fld":"vLANGUAGE","hsh":true},{"av":"cmbavLogonto"},{"av":"AV21LogOnTo","fld":"vLOGONTO"}]""");
         ...
         setEventMetadata("ENTER","""{"handler":"E130U2","iparms":[{"av":"AV17KeepMeLoggedIn","fld":"vKEEPMELOGGEDIN"},{"av":"AV22RememberMe","fld":"vREMEMBERME"},{"av":"AV13IDP_State","fld":"vIDP_STATE"},{"av":"cmbavLogonto"},{"av":"AV21LogOnTo","fld":"vLOGONTO"},{"av":"AV28UserName","fld":"vUSERNAME"},{"av":"AV29UserPassword","fld":"vUSERPASSWORD"}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV13IDP_State","fld":"vIDP_STATE"},{"av":"AV29UserPassword","fld":"vUSERPASSWORD"}]}""");
         setEventMetadata("'FORGOTPASSWORD'","""{"handler":"E110U1","iparms":[{"av":"AV13IDP_State","fld":"vIDP_STATE"}]""");
         setEventMetadata("'FORGOTPASSWORD'",""","oparms":[{"av":"AV13IDP_State","fld":"vIDP_STATE"}]}""");
         setEventMetadata("'SELECTAUTHENTICATIONTYPE'","""{"handler":"E140U2","iparms":[{"av":"AV17KeepMeLoggedIn","fld":"vKEEPMELOGGEDIN"},{"av":"AV22RememberMe","fld":"vREMEMBERME"},{"av":"AV48NameAuthType","fld":"vNAMEAUTHTYPE","hsh":true},{"av":"AV13IDP_State","fld":"vIDP_STATE"},{"av":"AV28UserName","fld":"vUSERNAME"},{"av":"AV29UserPassword","fld":"vUSERPASSWORD"}]}""");

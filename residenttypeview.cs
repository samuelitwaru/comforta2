...
namespace GeneXus.Programs {
   public class residenttypeview : GXDataArea
   {
      ...
      {
         GxWebStd.gx_hidden_field( context, "vRESIDENTTYPEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10ResidentTypeId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vRESIDENTTYPEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10ResidentTypeId), "ZZZ9"), context));
      ...
      protected void WB220( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to Resident Type", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_ResidentTypeView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblResident_title_Internalname, "Resident", "", "", lblResident_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ResidentTypeView.htm");
            /* Div Control */
      ...
      protected void START222( )
      {
         ...
         Form.Meta.addItem("description", "Resident Type View", 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP220( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10ResidentTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vRESIDENTTYPEID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249126312983", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("residenttypeview.js", "?20249126312983", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Resident Type View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV10ResidentTypeId","fld":"vRESIDENTTYPEID","pic":"ZZZ9","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]}""");
         return  ;
      }

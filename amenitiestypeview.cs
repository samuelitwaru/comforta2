...
namespace GeneXus.Programs {
   public class amenitiestypeview : GXDataArea
   {
      ...
      {
         GxWebStd.gx_hidden_field( context, "vAMENITIESTYPEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10AmenitiesTypeId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vAMENITIESTYPEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10AmenitiesTypeId), "ZZZ9"), context));
      ...
      protected void WB330( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to Amenities Type", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_AmenitiesTypeView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblAmenities_title_Internalname, "Amenities", "", "", lblAmenities_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_AmenitiesTypeView.htm");
            /* Div Control */
      ...
      protected void START332( )
      {
         ...
         Form.Meta.addItem("description", "Amenities Type View", 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP330( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10AmenitiesTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vAMENITIESTYPEID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249126314315", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("amenitiestypeview.js", "?20249126314315", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Amenities Type View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }

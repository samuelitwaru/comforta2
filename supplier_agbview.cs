...
namespace GeneXus.Programs {
   public class supplier_agbview : GXDataArea
   {
      ...
      {
         GxWebStd.gx_hidden_field( context, "vSUPPLIER_AGBID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10Supplier_AgbId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vSUPPLIER_AGBID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10Supplier_AgbId), "ZZZ9"), context));
      ...
      protected void WB210( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Back to AGB Suppliers", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Supplier_AgbView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProductservice_title_Internalname, "Product Service", "", "", lblProductservice_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Supplier_AgbView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSupplier_agbcustomer_title_Internalname, "Customer", "", "", lblSupplier_agbcustomer_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Supplier_AgbView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
      ...
      protected void START212( )
      {
         ...
         Form.Meta.addItem("description", "Supplier_Agb View", 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP210( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10Supplier_AgbId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vSUPPLIER_AGBID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024912631393", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("supplier_agbview.js", "?2024912631393", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Supplier_Agb View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV10Supplier_AgbId","fld":"vSUPPLIER_AGBID","pic":"ZZZ9","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]}""");
         return  ;
      }

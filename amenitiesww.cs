...
namespace GeneXus.Programs {
   public class amenitiesww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV16FilterFullText, AV24ManageFiltersExecutionStep, AV19ColumnsSelector, AV47Pgmname, AV27TFAmenitiesName, AV28TFAmenitiesName_Sel, AV31TFAmenitiesTypeName, AV32TFAmenitiesTypeName_Sel, AV41IsAuthorized_Update, AV43IsAuthorized_Delete, AV44IsAuthorized_AmenitiesName, AV46IsAuthorized_AmenitiesTypeName, AV45IsAuthorized_Insert) ;
      ...
      protected void WB2Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(37), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_AmenitiesWW.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(37), 2, 0)+","+"null"+");", "Select columns", bttBtneditcolumns_Jsonclick, 0, "Select columns", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_AmenitiesWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_AMENITIESID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A98AmenitiesId), "ZZZ9"), context));
      ...
      protected void RF2Y2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A100AmenitiesTypeName = H002Y2_A100AmenitiesTypeName[0];
               A99AmenitiesTypeId = H002Y2_A99AmenitiesTypeId[0];
               A101AmenitiesName = H002Y2_A101AmenitiesName[0];
               A98AmenitiesId = H002Y2_A98AmenitiesId[0];
               A100AmenitiesTypeName = H002Y2_A100AmenitiesTypeName[0];
               /* Execute user event: Grid.Load */
               E192Y2 ();
      ...
      protected void send_integrity_lvl_hashes2Y2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_INSERT", AV45IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( "", AV45IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, "gxhash_AMENITIESID"+"_"+sGXsfl_37_idx, GetSecureSignedToken( sGXsfl_37_idx, context.localUtil.Format( (decimal)(A98AmenitiesId), "ZZZ9"), context));
      }
      ...
      private void E192Y2( )
      {
         ...
         {
            edtavUpdate_Link = formatLink("amenities.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A98AmenitiesId,4,0))}, new string[] {"Mode","AmenitiesId"}) ;
         }
         AV42Delete = "<i class=\"fa fa-times\"></i>";
         AssignAttri("", false, edtavDelete_Internalname, AV42Delete);
         if ( AV43IsAuthorized_Delete )
         {
            edtavDelete_Link = formatLink("amenities.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A98AmenitiesId,4,0))}, new string[] {"Mode","AmenitiesId"}) ;
         }
         ...
         {
            edtAmenitiesTypeName_Link = formatLink("amenitiestypeview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A99AmenitiesTypeId,4,0)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"AmenitiesTypeId","TabCode"}) ;
         }
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249126321887", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("amenitiesww.js", "?20249126321888", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_372( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtAmenitiesId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A98AmenitiesId), 4, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A98AmenitiesId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtAmenitiesId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)37,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void StartGridControl37( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Amenities Type Name") ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV47Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV27TFAmenitiesName","fld":"vTFAMENITIESNAME"},{"av":"AV28TFAmenitiesName_Sel","fld":"vTFAMENITIESNAME_SEL"},{"av":"AV31TFAmenitiesTypeName","fld":"vTFAMENITIESTYPENAME"},{"av":"AV32TFAmenitiesTypeName_Sel","fld":"vTFAMENITIESTYPENAME_SEL"},{"av":"AV41IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV43IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_AmenitiesName","fld":"vISAUTHORIZED_AMENITIESNAME","hsh":true},{"av":"AV46IsAuthorized_AmenitiesTypeName","fld":"vISAUTHORIZED_AMENITIESTYPENAME","hsh":true},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtAmenitiesName_Visible","ctrl":"AMENITIESNAME","prop":"Visible"},{"av":"edtAmenitiesTypeName_Visible","ctrl":"AMENITIESTYPENAME","prop":"Visible"},{"av":"AV37GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV38GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV39GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV41IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV43IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV22ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E122Y2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV47Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV27TFAmenitiesName","fld":"vTFAMENITIESNAME"},{"av":"AV28TFAmenitiesName_Sel","fld":"vTFAMENITIESNAME_SEL"},{"av":"AV31TFAmenitiesTypeName","fld":"vTFAMENITIESTYPENAME"},{"av":"AV32TFAmenitiesTypeName_Sel","fld":"vTFAMENITIESTYPENAME_SEL"},{"av":"AV41IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV43IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_AmenitiesName","fld":"vISAUTHORIZED_AMENITIESNAME","hsh":true},{"av":"AV46IsAuthorized_AmenitiesTypeName","fld":"vISAUTHORIZED_AMENITIESTYPENAME","hsh":true},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E132Y2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV47Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV27TFAmenitiesName","fld":"vTFAMENITIESNAME"},{"av":"AV28TFAmenitiesName_Sel","fld":"vTFAMENITIESNAME_SEL"},{"av":"AV31TFAmenitiesTypeName","fld":"vTFAMENITIESTYPENAME"},{"av":"AV32TFAmenitiesTypeName_Sel","fld":"vTFAMENITIESTYPENAME_SEL"},{"av":"AV41IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV43IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_AmenitiesName","fld":"vISAUTHORIZED_AMENITIESNAME","hsh":true},{"av":"AV46IsAuthorized_AmenitiesTypeName","fld":"vISAUTHORIZED_AMENITIESTYPENAME","hsh":true},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E142Y2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV47Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV27TFAmenitiesName","fld":"vTFAMENITIESNAME"},{"av":"AV28TFAmenitiesName_Sel","fld":"vTFAMENITIESNAME_SEL"},{"av":"AV31TFAmenitiesTypeName","fld":"vTFAMENITIESTYPENAME"},{"av":"AV32TFAmenitiesTypeName_Sel","fld":"vTFAMENITIESTYPENAME_SEL"},{"av":"AV41IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV43IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_AmenitiesName","fld":"vISAUTHORIZED_AMENITIESNAME","hsh":true},{"av":"AV46IsAuthorized_AmenitiesTypeName","fld":"vISAUTHORIZED_AMENITIESTYPENAME","hsh":true},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"},{"av":"Ddo_grid_Selectedcolumn","ctrl":"DDO_GRID","prop":"SelectedColumn"},{"av":"Ddo_grid_Filteredtext_get","ctrl":"DDO_GRID","prop":"FilteredText_get"}]""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",""","oparms":[{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV27TFAmenitiesName","fld":"vTFAMENITIESNAME"},{"av":"AV28TFAmenitiesName_Sel","fld":"vTFAMENITIESNAME_SEL"},{"av":"AV31TFAmenitiesTypeName","fld":"vTFAMENITIESTYPENAME"},{"av":"AV32TFAmenitiesTypeName_Sel","fld":"vTFAMENITIESTYPENAME_SEL"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E192Y2","iparms":[{"av":"AV41IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A98AmenitiesId","fld":"AMENITIESID","pic":"ZZZ9","hsh":true},{"av":"AV43IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_AmenitiesName","fld":"vISAUTHORIZED_AMENITIESNAME","hsh":true},{"av":"AV46IsAuthorized_AmenitiesTypeName","fld":"vISAUTHORIZED_AMENITIESTYPENAME","hsh":true},{"av":"A99AmenitiesTypeId","fld":"AMENITIESTYPEID","pic":"ZZZ9"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV40Update","fld":"vUPDATE"},{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"AV42Delete","fld":"vDELETE"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtAmenitiesName_Link","ctrl":"AMENITIESNAME","prop":"Link"},{"av":"edtAmenitiesTypeName_Link","ctrl":"AMENITIESTYPENAME","prop":"Link"}]}""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","""{"handler":"E152Y2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV47Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV27TFAmenitiesName","fld":"vTFAMENITIESNAME"},{"av":"AV28TFAmenitiesName_Sel","fld":"vTFAMENITIESNAME_SEL"},{"av":"AV31TFAmenitiesTypeName","fld":"vTFAMENITIESTYPENAME"},{"av":"AV32TFAmenitiesTypeName_Sel","fld":"vTFAMENITIESTYPENAME_SEL"},{"av":"AV41IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV43IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_AmenitiesName","fld":"vISAUTHORIZED_AMENITIESNAME","hsh":true},{"av":"AV46IsAuthorized_AmenitiesTypeName","fld":"vISAUTHORIZED_AMENITIESTYPENAME","hsh":true},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_gridcolumnsselector_Columnsselectorvalues","ctrl":"DDO_GRIDCOLUMNSSELECTOR","prop":"ColumnsSelectorValues"}]""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",""","oparms":[{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"edtAmenitiesName_Visible","ctrl":"AMENITIESNAME","prop":"Visible"},{"av":"edtAmenitiesTypeName_Visible","ctrl":"AMENITIESTYPENAME","prop":"Visible"},{"av":"AV37GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV38GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV39GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV41IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV43IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV22ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E112Y2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV47Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV27TFAmenitiesName","fld":"vTFAMENITIESNAME"},{"av":"AV28TFAmenitiesName_Sel","fld":"vTFAMENITIESNAME_SEL"},{"av":"AV31TFAmenitiesTypeName","fld":"vTFAMENITIESTYPENAME"},{"av":"AV32TFAmenitiesTypeName_Sel","fld":"vTFAMENITIESTYPENAME_SEL"},{"av":"AV41IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV43IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_AmenitiesName","fld":"vISAUTHORIZED_AMENITIESNAME","hsh":true},{"av":"AV46IsAuthorized_AmenitiesTypeName","fld":"vISAUTHORIZED_AMENITIESTYPENAME","hsh":true},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV27TFAmenitiesName","fld":"vTFAMENITIESNAME"},{"av":"AV28TFAmenitiesName_Sel","fld":"vTFAMENITIESNAME_SEL"},{"av":"AV31TFAmenitiesTypeName","fld":"vTFAMENITIESTYPENAME"},{"av":"AV32TFAmenitiesTypeName_Sel","fld":"vTFAMENITIESTYPENAME_SEL"},{"av":"Ddo_grid_Selectedvalue_set","ctrl":"DDO_GRID","prop":"SelectedValue_set"},{"av":"Ddo_grid_Filteredtext_set","ctrl":"DDO_GRID","prop":"FilteredText_set"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtAmenitiesName_Visible","ctrl":"AMENITIESNAME","prop":"Visible"},{"av":"edtAmenitiesTypeName_Visible","ctrl":"AMENITIESTYPENAME","prop":"Visible"},{"av":"AV37GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV38GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV39GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV41IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV43IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV22ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E162Y2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV47Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV27TFAmenitiesName","fld":"vTFAMENITIESNAME"},{"av":"AV28TFAmenitiesName_Sel","fld":"vTFAMENITIESNAME_SEL"},{"av":"AV31TFAmenitiesTypeName","fld":"vTFAMENITIESTYPENAME"},{"av":"AV32TFAmenitiesTypeName_Sel","fld":"vTFAMENITIESTYPENAME_SEL"},{"av":"AV41IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV43IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV44IsAuthorized_AmenitiesName","fld":"vISAUTHORIZED_AMENITIESNAME","hsh":true},{"av":"AV46IsAuthorized_AmenitiesTypeName","fld":"vISAUTHORIZED_AMENITIESTYPENAME","hsh":true},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A98AmenitiesId","fld":"AMENITIESID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("'DOINSERT'",""","oparms":[{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtAmenitiesName_Visible","ctrl":"AMENITIESNAME","prop":"Visible"},{"av":"edtAmenitiesTypeName_Visible","ctrl":"AMENITIESTYPENAME","prop":"Visible"},{"av":"AV37GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV38GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV39GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV41IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV43IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV22ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         AV52Amenitieswwds_5_tfamenitiestypename_sel = "";
         AV51Amenitieswwds_4_tfamenitiestypename = "";
         H002Y2_A100AmenitiesTypeName = new string[] {""} ;
         H002Y2_A99AmenitiesTypeId = new short[1] ;
         H002Y2_A101AmenitiesName = new string[] {""} ;
         H002Y2_A98AmenitiesId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.amenitiesww__default(),
            new Object[][] {
                new Object[] {
               H002Y2_A100AmenitiesTypeName, H002Y2_A99AmenitiesTypeId, H002Y2_A101AmenitiesName, H002Y2_A98AmenitiesId
               }
               , new Object[] {
      ...
      private string[] H002Y2_A100AmenitiesTypeName ;
      private short[] H002Y2_A99AmenitiesTypeId ;
      private string[] H002Y2_A101AmenitiesName ;
      private short[] H002Y2_A98AmenitiesId ;
   ...
   public class amenitiesww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002Y2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] , (bool)dynConstraints[8] );
               case 1 :
                     return conditional_H002Y3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (short)dynConstraints[7] , (bool)dynConstraints[8] );
         }

   ...
   public class agendacalendar : GXDataArea
   {
      ...
      protected void WB3L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncreateevent_Internalname, "", "Create Event", bttBtncreateevent_Jsonclick, 5, "Create Event", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOCREATEEVENT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_AgendaCalendar.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWwp_search_Internalname, "Search", "", "", lblWwp_search_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, 0, "HLP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTitlefilter_Internalname, AV36TitleFilter, StringUtil.RTrim( context.localUtil.Format( AV36TitleFilter, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Title", edtavTitlefilter_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTitlefilter_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockdatetypefilter_Internalname, "Date", "", "", lblTextblockdatetypefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavDatetypefilter, cmbavDatetypefilter_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV20DateTypeFilter), 4, 0)), 1, cmbavDatetypefilter_Jsonclick, 7, "'"+""+"'"+",false,"+"'"+"e113l1_client"+"'", "int", "", 1, cmbavDatetypefilter.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "", true, 0, "HLP_AgendaCalendar.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuaclear_Internalname, "", "Clear", bttBtnuaclear_Jsonclick, 5, "Clear", "", StyleString, ClassString, bttBtnuaclear_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOUACLEAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuasearch_Internalname, "", "Search", bttBtnuasearch_Jsonclick, 5, "Search", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOUASEARCH\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndummydelete_Internalname, "", "Dummy Delete Event", bttBtndummydelete_Jsonclick, 7, "Dummy Delete Event", "", StyleString, ClassString, bttBtndummydelete_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e123l1_client"+"'", TempTags, "", 2, "HLP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            context.WriteHtmlTextNl( "</div>") ;
            wb_table1_52_3L2( true) ;
         }
         else
         {
            wb_table1_52_3L2( false) ;
         }
         return  ;
      }

      protected void wb_table1_52_3L2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_57_3L2( true) ;
         }
         else
         {
            wb_table2_57_3L2( false) ;
         }
         return  ;
      }

      protected void wb_table2_57_3L2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
      ...
      protected void START3L2( )
      {
         ...
         Form.Meta.addItem("description", "Agenda Calendar", 0) ;
         context.wjLoc = "";
      ...
      protected void S152( )
      {
         ...
         if ( ( DateTimeUtil.ResetTime ( AV23DotsFromDate ) < DateTimeUtil.ResetTime ( AV31LoadedDotsFromDate ) ) || ( DateTimeUtil.ResetTime ( AV24DotsToDate ) > DateTimeUtil.ResetTime ( AV32LoadedDotsToDate ) ) )
         {
            ...
            if ( ( DateTimeUtil.ResetTime ( AV23DotsFromDate ) < DateTimeUtil.ResetTime ( AV33LoadedFromDate ) ) || ( DateTimeUtil.ResetTime ( AV24DotsToDate ) > DateTimeUtil.ResetTime ( AV34LoadedToDate ) ) )
            {
               ...
               AV26EventsAux = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta2");
            }
            else
            {
               GXt_SdtWWPDateRangePickerOptions5 = AV37WWPDateRangePickerOptions;
      ...
      protected void E263L2( )
      {
         /* Load Routine */
         returnInSub = false;
      }

      protected void wb_table2_57_3L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_57_3L2e( true) ;
         }
         else
         {
            wb_table2_57_3L2e( false) ;
         }
      }

      protected void wb_table1_52_3L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_52_3L2e( true) ;
         }
         else
         {
            wb_table1_52_3L2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249126315856", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("agendacalendar.js", "?20249126315856", false, true);
         context.AddJavascriptSource("DVelop/Calendar/index.global.min.js", "", false, true);
         context.AddJavascriptSource("DVelop/Calendar/WWPCalendarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/daterangepicker/locales.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/daterangepicker/wwp-daterangepicker.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUASEARCH'","""{"handler":"E233L2","iparms":[{"av":"Calendaruc_Filtermode","ctrl":"CALENDARUC","prop":"FilterMode"},{"av":"AV29ForceLoadDots","fld":"vFORCELOADDOTS"},{"av":"AV27EventsLoaded","fld":"vEVENTSLOADED"},{"av":"AV10CalendarLoadFromDate","fld":"vCALENDARLOADFROMDATE"},{"av":"AV11CalendarLoadToDate","fld":"vCALENDARLOADTODATE"},{"av":"cmbavDatetypefilter"},{"av":"AV20DateTypeFilter","fld":"vDATETYPEFILTER","pic":"ZZZ9"},{"av":"Gx_date","fld":"vTODAY","hsh":true},{"av":"AV14DateFilter","fld":"vDATEFILTER"},{"av":"AV15DateRangeFilter","fld":"vDATERANGEFILTER"},{"av":"AV17DateRangeFilter_To","fld":"vDATERANGEFILTER_TO"},{"av":"AV36TitleFilter","fld":"vTITLEFILTER"},{"av":"AV19DateToSearchFrom","fld":"vDATETOSEARCHFROM"},{"av":"AV18DatesToSearchTo","fld":"vDATESTOSEARCHTO"},{"av":"AV13Date_ShowingDatesFrom","fld":"vDATE_SHOWINGDATESFROM"},{"av":"AV31LoadedDotsFromDate","fld":"vLOADEDDOTSFROMDATE"},{"av":"AV32LoadedDotsToDate","fld":"vLOADEDDOTSTODATE"},{"av":"AV33LoadedFromDate","fld":"vLOADEDFROMDATE"},{"av":"AV34LoadedToDate","fld":"vLOADEDTODATE"},{"av":"Calendaruc_Defaulteventstyle","ctrl":"CALENDARUC","prop":"DefaultEventStyle"},{"av":"AV25Events","fld":"vEVENTS"}]""");
         ...
         setEventMetadata("CREATEEVENT_MODAL.CLOSE","""{"handler":"E183L2","iparms":[{"av":"Createevent_modal_Result","ctrl":"CREATEEVENT_MODAL","prop":"Result"},{"av":"AV29ForceLoadDots","fld":"vFORCELOADDOTS"},{"av":"AV27EventsLoaded","fld":"vEVENTSLOADED"},{"av":"AV10CalendarLoadFromDate","fld":"vCALENDARLOADFROMDATE"},{"av":"AV11CalendarLoadToDate","fld":"vCALENDARLOADTODATE"},{"av":"Calendaruc_Filtermode","ctrl":"CALENDARUC","prop":"FilterMode"},{"av":"AV7CalendarEventId","fld":"vCALENDAREVENTID"},{"av":"cmbavDatetypefilter"},{"av":"AV20DateTypeFilter","fld":"vDATETYPEFILTER","pic":"ZZZ9"},{"av":"Gx_date","fld":"vTODAY","hsh":true},{"av":"AV14DateFilter","fld":"vDATEFILTER"},{"av":"AV15DateRangeFilter","fld":"vDATERANGEFILTER"},{"av":"AV17DateRangeFilter_To","fld":"vDATERANGEFILTER_TO"},{"av":"AV36TitleFilter","fld":"vTITLEFILTER"},{"av":"AV19DateToSearchFrom","fld":"vDATETOSEARCHFROM"},{"av":"AV18DatesToSearchTo","fld":"vDATESTOSEARCHTO"},{"av":"AV13Date_ShowingDatesFrom","fld":"vDATE_SHOWINGDATESFROM"},{"av":"AV31LoadedDotsFromDate","fld":"vLOADEDDOTSFROMDATE"},{"av":"AV32LoadedDotsToDate","fld":"vLOADEDDOTSTODATE"},{"av":"AV33LoadedFromDate","fld":"vLOADEDFROMDATE"},{"av":"AV34LoadedToDate","fld":"vLOADEDTODATE"},{"av":"Calendaruc_Defaulteventstyle","ctrl":"CALENDARUC","prop":"DefaultEventStyle"},{"av":"AV25Events","fld":"vEVENTS"}]""");
         ...
         setEventMetadata("VDATE.CONTROLVALUECHANGED","""{"handler":"E243L2","iparms":[{"av":"AV12Date","fld":"vDATE"}]""");
         setEventMetadata("VDATE.CONTROLVALUECHANGED",""","oparms":[{"av":"AV6CalendarCurrentDate","fld":"vCALENDARCURRENTDATE"}]}""");
         setEventMetadata("CALENDARUC.EVENTDATEUPDATED","""{"handler":"E143L2","iparms":[{"av":"Calendaruc_Datetimeselected","ctrl":"CALENDARUC","prop":"DateTimeSelected"},{"av":"AV29ForceLoadDots","fld":"vFORCELOADDOTS"},{"av":"AV27EventsLoaded","fld":"vEVENTSLOADED"},{"av":"AV10CalendarLoadFromDate","fld":"vCALENDARLOADFROMDATE"},{"av":"AV11CalendarLoadToDate","fld":"vCALENDARLOADTODATE"},{"av":"Calendaruc_Filtermode","ctrl":"CALENDARUC","prop":"FilterMode"},{"av":"cmbavDatetypefilter"},{"av":"AV20DateTypeFilter","fld":"vDATETYPEFILTER","pic":"ZZZ9"},{"av":"Gx_date","fld":"vTODAY","hsh":true},{"av":"AV14DateFilter","fld":"vDATEFILTER"},{"av":"AV15DateRangeFilter","fld":"vDATERANGEFILTER"},{"av":"AV17DateRangeFilter_To","fld":"vDATERANGEFILTER_TO"},{"av":"AV36TitleFilter","fld":"vTITLEFILTER"},{"av":"AV19DateToSearchFrom","fld":"vDATETOSEARCHFROM"},{"av":"AV18DatesToSearchTo","fld":"vDATESTOSEARCHTO"},{"av":"AV13Date_ShowingDatesFrom","fld":"vDATE_SHOWINGDATESFROM"},{"av":"AV31LoadedDotsFromDate","fld":"vLOADEDDOTSFROMDATE"},{"av":"AV32LoadedDotsToDate","fld":"vLOADEDDOTSTODATE"},{"av":"AV33LoadedFromDate","fld":"vLOADEDFROMDATE"},{"av":"AV34LoadedToDate","fld":"vLOADEDTODATE"},{"av":"Calendaruc_Defaulteventstyle","ctrl":"CALENDARUC","prop":"DefaultEventStyle"},{"av":"AV25Events","fld":"vEVENTS"}]""");
         ...
         setEventMetadata("CALENDARUC.EVENTSELECTED","""{"handler":"E133L2","iparms":[{"av":"Calendaruc_Itemselected","ctrl":"CALENDARUC","prop":"ItemSelected"}]""");
         setEventMetadata("CALENDARUC.EVENTSELECTED",""","oparms":[{"av":"AV7CalendarEventId","fld":"vCALENDAREVENTID"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"}]}""");
         setEventMetadata("CALENDARUC.DELETEEVENT","""{"handler":"E153L2","iparms":[{"av":"Calendaruc_Itemselected","ctrl":"CALENDARUC","prop":"ItemSelected"},{"av":"AV7CalendarEventId","fld":"vCALENDAREVENTID"}]""");
         ...
         setEventMetadata("VDATE_SHOWINGDATESFROM.CONTROLVALUECHANGED","""{"handler":"E253L2","iparms":[{"av":"AV27EventsLoaded","fld":"vEVENTSLOADED"},{"av":"AV13Date_ShowingDatesFrom","fld":"vDATE_SHOWINGDATESFROM"},{"av":"AV31LoadedDotsFromDate","fld":"vLOADEDDOTSFROMDATE"},{"av":"AV32LoadedDotsToDate","fld":"vLOADEDDOTSTODATE"},{"av":"AV33LoadedFromDate","fld":"vLOADEDFROMDATE"},{"av":"AV34LoadedToDate","fld":"vLOADEDTODATE"},{"av":"Calendaruc_Defaulteventstyle","ctrl":"CALENDARUC","prop":"DefaultEventStyle"},{"av":"AV25Events","fld":"vEVENTS"}]""");
         ...
         setEventMetadata("VDATETYPEFILTER.CLICK","""{"handler":"E113L1","iparms":[{"av":"cmbavDatetypefilter"},{"av":"AV20DateTypeFilter","fld":"vDATETYPEFILTER","pic":"ZZZ9"}]""");
      ...
      public override void initialize( )
      {
         ...
         GXKey = "";
         AV25Events = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta2");
         ...
         GXt_objcol_SdtWWP_Calendar_Events_Item3 = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta2");

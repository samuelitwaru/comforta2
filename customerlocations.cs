...
namespace GeneXus.Programs {
   public class customerlocations : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249131556125", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customerlocations.js", "?20249131556126", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_372( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavCustomerlocationsdts__customerid_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(((SdtCustomerLocationSDT)AV8CustomerLocationSDTs.Item(AV33GXV1)).gxTpr_Customerid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( ((edtavCustomerlocationsdts__customerid_Enabled!=0) ? context.localUtil.Format( (decimal)(((SdtCustomerLocationSDT)AV8CustomerLocationSDTs.Item(AV33GXV1)).gxTpr_Customerid), "ZZZ9") : context.localUtil.Format( (decimal)(((SdtCustomerLocationSDT)AV8CustomerLocationSDTs.Item(AV33GXV1)).gxTpr_Customerid), "ZZZ9")))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+""+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" ",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavCustomerlocationsdts__customerid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavCustomerlocationsdts__customerid_Enabled,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)37,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavCustomerlocationsdts__customerlocationid_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(((SdtCustomerLocationSDT)AV8CustomerLocationSDTs.Item(AV33GXV1)).gxTpr_Customerlocationid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( ((edtavCustomerlocationsdts__customerlocationid_Enabled!=0) ? context.localUtil.Format( (decimal)(((SdtCustomerLocationSDT)AV8CustomerLocationSDTs.Item(AV33GXV1)).gxTpr_Customerlocationid), "ZZZ9") : context.localUtil.Format( (decimal)(((SdtCustomerLocationSDT)AV8CustomerLocationSDTs.Item(AV33GXV1)).gxTpr_Customerlocationid), "ZZZ9")))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+""+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" ",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavCustomerlocationsdts__customerlocationid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavCustomerlocationsdts__customerlocationid_Enabled,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)37,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {

   ...
   public class pagegeneral : GXWebComponent
   {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AssignAttri(sPrefix, false, "A103PageId", StringUtil.LTrimStr( (decimal)(A103PageId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)A103PageId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("pagegeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A103PageId,4,0))}, new string[] {"PageId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA103PageId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA103PageId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_UPDATE", AV12IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV12IsAuthorized_Update, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV13IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV13IsAuthorized_Delete, context));
      ...
      protected void WB3D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtPageName_Internalname, A104PageName, StringUtil.RTrim( context.localUtil.Format( A104PageName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,17);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPageName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPageName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_PageGeneral.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtCustomerKvkNumber_Internalname, A41CustomerKvkNumber, StringUtil.RTrim( context.localUtil.Format( A41CustomerKvkNumber, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerKvkNumber_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerKvkNumber_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, -1, true, "KvkNumber", "start", true, "", "HLP_PageGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtCustomerName_Internalname, A3CustomerName, StringUtil.RTrim( context.localUtil.Format( A3CustomerName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_PageGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtCustomerEmail_Internalname, A5CustomerEmail, StringUtil.RTrim( context.localUtil.Format( A5CustomerEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,30);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "mailto:"+A5CustomerEmail, "", "", "", edtCustomerEmail_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerEmail_Enabled, 0, "email", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Email", "start", true, "", "HLP_PageGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", context.GetMessage( "GXM_update", ""), bttBtnupdate_Jsonclick, 7, context.GetMessage( "GXM_update", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e113d1_client"+"'", TempTags, "", 2, "HLP_PageGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", context.GetMessage( "GX_BtnDelete", ""), bttBtndelete_Jsonclick, 7, context.GetMessage( "GX_BtnDelete", ""), "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e123d1_client"+"'", TempTags, "", 2, "HLP_PageGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPageId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A103PageId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A103PageId), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPageId_Jsonclick, 0, "Attribute", "", "", "", "", edtPageId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_PageGeneral.htm");
            /* Multiple line edit */
            ClassString = "Attribute";
            StyleString = "";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtPageHtmlContent_Internalname, A105PageHtmlContent, "", "", 0, edtPageHtmlContent_Visible, 0, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "5242880", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_PageGeneral.htm");
            /* Multiple line edit */
            ClassString = "Attribute";
            StyleString = "";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtPageJsonContent_Internalname, A106PageJsonContent, "", "", 0, edtPageJsonContent_Visible, 0, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "2097152", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_PageGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF3D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1CustomerId = H003D2_A1CustomerId[0];
               A106PageJsonContent = H003D2_A106PageJsonContent[0];
               AssignAttri(sPrefix, false, "A106PageJsonContent", A106PageJsonContent);
               A105PageHtmlContent = H003D2_A105PageHtmlContent[0];
               AssignAttri(sPrefix, false, "A105PageHtmlContent", A105PageHtmlContent);
               A5CustomerEmail = H003D2_A5CustomerEmail[0];
               n5CustomerEmail = H003D2_n5CustomerEmail[0];
               AssignAttri(sPrefix, false, "A5CustomerEmail", A5CustomerEmail);
               A3CustomerName = H003D2_A3CustomerName[0];
               AssignAttri(sPrefix, false, "A3CustomerName", A3CustomerName);
               A41CustomerKvkNumber = H003D2_A41CustomerKvkNumber[0];
               AssignAttri(sPrefix, false, "A41CustomerKvkNumber", A41CustomerKvkNumber);
               A104PageName = H003D2_A104PageName[0];
               AssignAttri(sPrefix, false, "A104PageName", A104PageName);
               A5CustomerEmail = H003D2_A5CustomerEmail[0];
               n5CustomerEmail = H003D2_n5CustomerEmail[0];
               AssignAttri(sPrefix, false, "A5CustomerEmail", A5CustomerEmail);
               A3CustomerName = H003D2_A3CustomerName[0];
      ...
      protected void STRUP3D0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA103PageId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA103PageId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A103PageId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "A103PageId", StringUtil.LTrimStr( (decimal)(A103PageId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA103PageId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A103PageId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "A103PageId", StringUtil.LTrimStr( (decimal)(A103PageId), 4, 0));
         }
         wcpOA103PageId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA103PageId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( A103PageId != wcpOA103PageId ) ) )
         {
            setjustcreated();
         }
         wcpOA103PageId = A103PageId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA103PageId = cgiGet( sPrefix+"A103PageId_CTRL");
         if ( StringUtil.Len( sCtrlA103PageId) > 0 )
         {
            A103PageId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlA103PageId), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "A103PageId", StringUtil.LTrimStr( (decimal)(A103PageId), 4, 0));
         }
         else
         {
            A103PageId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"A103PageId_PARM"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A103PageId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A103PageId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA103PageId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A103PageId_CTRL", StringUtil.RTrim( sCtrlA103PageId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202491315534454", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("pagegeneral.js", "?202491315534454", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A103PageId","fld":"PAGEID","pic":"ZZZ9"},{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]}""");
         setEventMetadata("'DOUPDATE'","""{"handler":"E113D1","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A103PageId","fld":"PAGEID","pic":"ZZZ9"}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E123D1","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A103PageId","fld":"PAGEID","pic":"ZZZ9"}]""");
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         H003D2_A1CustomerId = new short[1] ;
         H003D2_A103PageId = new short[1] ;
         H003D2_A106PageJsonContent = new string[] {""} ;
         H003D2_A105PageHtmlContent = new string[] {""} ;
         H003D2_A5CustomerEmail = new string[] {""} ;
         H003D2_n5CustomerEmail = new bool[] {false} ;
         H003D2_A3CustomerName = new string[] {""} ;
         H003D2_A41CustomerKvkNumber = new string[] {""} ;
         H003D2_A104PageName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.pagegeneral__default(),
            new Object[][] {
                new Object[] {
               H003D2_A1CustomerId, H003D2_A103PageId, H003D2_A106PageJsonContent, H003D2_A105PageHtmlContent, H003D2_A5CustomerEmail, H003D2_n5CustomerEmail, H003D2_A3CustomerName, H003D2_A41CustomerKvkNumber, H003D2_A104PageName
               }
            }
         );
         AV14Pgmname = "PageGeneral";
      ...
      private string sCtrlA103PageId ;
      ...
      private short[] H003D2_A1CustomerId ;
      private short[] H003D2_A103PageId ;
      private string[] H003D2_A106PageJsonContent ;
      private string[] H003D2_A105PageHtmlContent ;
      private string[] H003D2_A5CustomerEmail ;
      private bool[] H003D2_n5CustomerEmail ;
      private string[] H003D2_A3CustomerName ;
      private string[] H003D2_A41CustomerKvkNumber ;
      private string[] H003D2_A104PageName ;

...
namespace GeneXus.Programs {
   public class customercustomizationview : GXDataArea
   {
      ...
      {
         GxWebStd.gx_hidden_field( context, "vCUSTOMERCUSTOMIZATIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10CustomerCustomizationId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCUSTOMERCUSTOMIZATIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CustomerCustomizationId), "ZZZ9"), context));
      ...
      {
         return "Customer Customization View" ;
      }
      ...
      protected void WB3I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to Customer Customization", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_CustomerCustomizationView.htm");
      ...
      protected void START3I2( )
      {
         ...
         Form.Meta.addItem("description", "Customer Customization View", 0) ;
         context.wjLoc = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249126315126", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customercustomizationview.js", "?20249126315126", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Customer Customization View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }

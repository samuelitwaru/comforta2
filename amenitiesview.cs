...
namespace GeneXus.Programs {
   public class amenitiesview : GXDataArea
   {
      ...
      {
         GxWebStd.gx_hidden_field( context, "vAMENITIESID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10AmenitiesId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vAMENITIESID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10AmenitiesId), "ZZZ9"), context));
      ...
      protected void WB310( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to Amenities", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_AmenitiesView.htm");
      ...
      protected void START312( )
      {
         ...
         Form.Meta.addItem("description", "Amenities View", 0) ;
         context.wjLoc = "";
      ...
      protected void E11312( )
      {
         ...
         {
            A98AmenitiesId = H00312_A98AmenitiesId[0];
            A101AmenitiesName = H00312_A101AmenitiesName[0];
            AV14GXLvl9 = 1;
            Form.Caption = A101AmenitiesName;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249126314272", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("amenitiesview.js", "?20249126314272", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         H00312_A98AmenitiesId = new short[1] ;
         H00312_A101AmenitiesName = new string[] {""} ;
         A101AmenitiesName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.amenitiesview__default(),
            new Object[][] {
                new Object[] {
               H00312_A98AmenitiesId, H00312_A101AmenitiesName
               }
            }
         );
      ...
      private short[] H00312_A98AmenitiesId ;
      private string[] H00312_A101AmenitiesName ;
   ...
   public class amenitiesview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00312", "SELECT AmenitiesId, AmenitiesName FROM Amenities WHERE AmenitiesId = :AV10AmenitiesId ORDER BY AmenitiesId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00312,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }

...
namespace GeneXus.Programs {
   public class customertypeview : GXDataArea
   {
      ...
      {
         GxWebStd.gx_hidden_field( context, "vCUSTOMERTYPEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10CustomerTypeId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCUSTOMERTYPEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CustomerTypeId), "ZZZ9"), context));
      ...
      protected void WB1R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Go to Customer Type", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_CustomerTypeView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCustomer_title_Internalname, "Customer", "", "", lblCustomer_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_CustomerTypeView.htm");
            /* Div Control */
      ...
      protected void START1R2( )
      {
         ...
         Form.Meta.addItem("description", "Customer Type View", 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP1R0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10CustomerTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vCUSTOMERTYPEID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249126312074", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customertypeview.js", "?20249126312074", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Customer Type View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV10CustomerTypeId","fld":"vCUSTOMERTYPEID","pic":"ZZZ9","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]}""");
         return  ;
      }

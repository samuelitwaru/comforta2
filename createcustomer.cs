...
namespace GeneXus.Programs {
   public class createcustomer : GXDataArea
   {
      ...
      protected void START2D2( )
      {
         ...
         Form.Meta.addItem("description", "Create Customer", 0) ;
         context.wjLoc = "";
      ...
      protected void E112D2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV15WizardSteps = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Comforta2");
         AV14WizardStep = new GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(context);
         AV14WizardStep.gxTpr_Code = "Step1";
         AV14WizardStep.gxTpr_Title = "Customer Information";
         AV14WizardStep.gxTpr_Description = "Customer Information";
      ...
      protected void E122D2( )
      {
         ...
         while ( AV18GXV1 <= AV15WizardSteps.Count )
         {
            ...
            if ( StringUtil.StrCmp(AV14WizardStep.gxTpr_Code, AV6CurrentStepAux) == 0 )
            {
               ...
               {
                  lblWizardstepdescription_Caption = StringUtil.Format( "Step %1/%2 : %3", StringUtil.Trim( StringUtil.Str( (decimal)(AV11StepNumber), 2, 0)), StringUtil.Trim( StringUtil.Str( (decimal)(AV15WizardSteps.Count), 9, 0)), AV14WizardStep.gxTpr_Description, "", "", "", "", "", "");
                  AssignProp("", false, lblWizardstepdescription_Internalname, "Caption", lblWizardstepdescription_Caption, true);
               }
            }
            else
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249126313657", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("createcustomer.js", "?20249126313657", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV15WizardSteps","fld":"vWIZARDSTEPS","hsh":true},{"av":"AV6CurrentStepAux","fld":"vCURRENTSTEPAUX","hsh":true},{"av":"AV9PreviousStep","fld":"vPREVIOUSSTEP","hsh":true},{"av":"AV5CurrentStep","fld":"vCURRENTSTEP","hsh":true},{"av":"AV7GoingBack","fld":"vGOINGBACK","hsh":true}]""");

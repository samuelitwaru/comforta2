   ...
   public class gamexamplelogin : GXDataArea
   {
      ...
      protected void WB0L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(62), 2, 0)+","+"null"+");", bttBtnenter_Caption, bttBtnenter_Jsonclick, 5, context.GetMessage( "GX_BtnEnter", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMExampleLogin.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 hidden-xs hidden-sm hidden-md hidden-lg DataContentCellLogin CellPaddingLogin", "start", "top", "", "", "div");
            wb_table1_50_0L2( true) ;
         }
         else
         {
            wb_table1_50_0L2( false) ;
         }
         return  ;
      }

      protected void wb_table1_50_0L2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "GRIDAUTHTYPES.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "VIMAGEAUTHTYPE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 26), "'SELECTAUTHENTICATIONTYPE'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "VIMAGEAUTHTYPE.CLICK") == 0 ) )
                           {
                              ...
                              AV58ImageAuthType = cgiGet( edtavImageauthtype_Internalname);
                              AssignProp("", false, edtavImageauthtype_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV58ImageAuthType)) ? AV72Imageauthtype_GXI : context.convertURL( context.PathToRelativeUrl( AV58ImageAuthType))), !bGXsfl_62_Refreshing);
                              AssignProp("", false, edtavImageauthtype_Internalname, "SrcSet", context.GetImageSrcSet( AV58ImageAuthType), true);
                              ...
                              AV59TypeAuthType = cgiGet( cmbavTypeauthtype_Internalname);
                              AssignAttri("", false, cmbavTypeauthtype_Internalname, AV59TypeAuthType);
      ...
      protected void E140L2( )
      {
         ...
         lblRegisteruser_Link = formatLink(context.GetMessage( "GAMRegisterUser", "")) ;
         ...
         else
         {
            if ( ! AV18isConnectionOK )
            {
               ...
               {
                  AV18isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnectionbyrepositoryguid(AV28RepositoryGUID, out  AV61Errors);
                  AssignAttri("", false, "AV18isConnectionOK", AV18isConnectionOK);
               }
               else
               {
                  ...
                  {
                     AV18isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnection(((GeneXus.Programs.genexussecurity.SdtGAMConnectionInfo)AV9ConnectionInfoCollection.Item(1)).gxTpr_Name, out  AV61Errors);
                     AssignAttri("", false, "AV18isConnectionOK", AV18isConnectionOK);
                  }
               }
            }
      ...
      private void E150L2( )
      {
         ...
         returnInSub = false;
         AV71GXV1 = 1;
         while ( AV71GXV1 <= AV7AuthenticationTypes.Count )
         {
            AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV71GXV1));
            if ( ! AV6AuthenticationType.gxTpr_Needusername )
            {
               ...
               {
                  AV58ImageAuthType = context.GetImagePath( AV6AuthenticationType.gxTpr_Smallimagename, "", context.GetTheme( ));
                  AssignAttri("", false, edtavImageauthtype_Internalname, AV58ImageAuthType);
                  AV72Imageauthtype_GXI = GXDbFile.PathToUrl( AV6AuthenticationType.gxTpr_Smallimagename, context);
               }
               else
               {
                  edtavImageauthtype_gximage = "GAM_GAMButtonGAMRemoteSmall";
                  AV58ImageAuthType = context.GetImagePath( "6cdd3e18-cc5b-44e0-bd22-3efaf48a6c40", "", context.GetTheme( ));
                  AssignAttri("", false, edtavImageauthtype_Internalname, AV58ImageAuthType);
                  AV72Imageauthtype_GXI = GXDbFile.PathToUrl( context.GetImagePath( "6cdd3e18-cc5b-44e0-bd22-3efaf48a6c40", "", context.GetTheme( )), context);
               }
               AV59TypeAuthType = AV6AuthenticationType.gxTpr_Type;
               AssignAttri("", false, cmbavTypeauthtype_Internalname, AV59TypeAuthType);
         ...
         cmbavTypeauthtype.CurrentValue = StringUtil.RTrim( AV59TypeAuthType);
      }
      ...
      protected void E120L2( )
      {
         ...
         {
            if ( AV61Errors.Count > 0 )
            {
               if ( ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV61Errors.Item(1)).gxTpr_Code == 24 ) || ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV61Errors.Item(1)).gxTpr_Code == 23 ) )
               {
               ...
               else if ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV61Errors.Item(1)).gxTpr_Code == 161 )
               {
               ...
               else if ( ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV61Errors.Item(1)).gxTpr_Code == 400 ) || ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV61Errors.Item(1)).gxTpr_Code == 410 ) )
               {
      ...
      protected void E160L2( )
      {
         ...
         /* Refresh Routine */
         returnInSub = false;
         AV63isRedirect = false;
         AV62ErrorsLogin = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getlasterrors();
         if ( AV62ErrorsLogin.Count > 0 )
         {
            if ( ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV62ErrorsLogin.Item(1)).gxTpr_Code == 1 ) || ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV62ErrorsLogin.Item(1)).gxTpr_Code == 104 ) )
            {
            }
            else
            {
         ...
         if ( ! AV63isRedirect )
         {
            AV67SessionValid = new GeneXus.Programs.genexussecurity.SdtGAMSession(context).isvalid(out  AV66Session, out  AV61Errors);
            if ( AV67SessionValid && ! AV66Session.gxTpr_Isanonymous )
            {
               ...
               {
                  AV68GAMApplicationCollection = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getapplications(AV69GAMApplicationFilter, out  AV61Errors);
                  AV73GXV2 = 1;
                  while ( AV73GXV2 <= AV68GAMApplicationCollection.Count )
                  {
                     AV70GAMApplication = ((GeneXus.Programs.genexussecurity.SdtGAMApplication)AV68GAMApplicationCollection.Item(AV73GXV2));
                     if ( StringUtil.StrCmp(AV70GAMApplication.gxTpr_Guid, "8d9934db-05db-4d64-adba-5e0466c3appU") != 0 )
                     {
                        if (true) break;
                     }
                     AV73GXV2 = (int)(AV73GXV2+1);
                  }
                  AV70GAMApplication = AV70GAMApplication.get();
                  if ( StringUtil.StrCmp(AV70GAMApplication.gxTpr_Homeobject, "") != 0 )
                  {
                     new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).applicationgohome(AV70GAMApplication.gxTpr_Guid) ;
                  }
                  else
                  {
                     CallWebObject(formatLink("home.aspx") );
            ...
            else
            {
               ...
               AV7AuthenticationTypes = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getenabledauthenticationtypes(AV23Language, out  AV61Errors);
               AV74GXV3 = 1;
               while ( AV74GXV3 <= AV7AuthenticationTypes.Count )
               {
                  AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV74GXV3));
                  if ( AV6AuthenticationType.gxTpr_Needusername )
                  {
               ...
               AV20isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getrememberlogin(out  AV25LogOnTo, out  AV8AuxUserName, out  AV33UserRememberMe, out  AV61Errors);
               ...
               AV65Repository = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).get();
               if ( cmbavLogonto.ItemCount > 1 )
               {
                  AV25LogOnTo = AV65Repository.gxTpr_Defaultauthenticationtypename;
                  AssignAttri("", false, "AV25LogOnTo", AV25LogOnTo);
               }
               ...
               if (returnInSub) return;
               AV75GXV4 = 1;
               while ( AV75GXV4 <= AV7AuthenticationTypes.Count )
               {
                  AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV75GXV4));
         ...
         AssignProp("", false, cmbavLogonto_Internalname, "Values", cmbavLogonto.ToJavascriptSource(), true);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV6AuthenticationType", AV6AuthenticationType);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV65Repository", AV65Repository);
      }
      ...
      protected void E130L2( )
      {
         ...
         AV19isModeOTP = false;
         AV76GXV5 = 1;
         while ( AV76GXV5 <= AV7AuthenticationTypes.Count )
         {
            AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV76GXV5));
            if ( StringUtil.StrCmp(AV6AuthenticationType.gxTpr_Name, AV25LogOnTo) == 0 )
            {
               /* Execute user subroutine: 'VALIDLOGONTOOTP' */
               S152 ();
      ...
      protected void S112( )
      {
         ...
         {
            AV18isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnectionbyrepositoryid(AV13GAMRepository.gxTpr_Authenticationmasterrepositoryid, out  AV61Errors);
            AssignAttri("", false, "AV18isConnectionOK", AV18isConnectionOK);
         }
         if ( ! AV18isConnectionOK )
         {
      ...
      protected void S142( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV65Repository.gxTpr_Userremembermetype, "Login") == 0 )
         {
            chkavKeepmeloggedin.Visible = 0;
            AssignProp("", false, chkavKeepmeloggedin_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(chkavKeepmeloggedin.Visible), 5, 0), true);
            chkavRememberme.Visible = 1;
         ...
         else if ( StringUtil.StrCmp(AV65Repository.gxTpr_Userremembermetype, "Auth") == 0 )
         {
            chkavKeepmeloggedin.Visible = 1;
            AssignProp("", false, chkavKeepmeloggedin_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(chkavKeepmeloggedin.Visible), 5, 0), true);
            chkavRememberme.Visible = 0;
         ...
         else if ( StringUtil.StrCmp(AV65Repository.gxTpr_Userremembermetype, "Both") == 0 )
         {
            chkavKeepmeloggedin.Visible = 1;
            AssignProp("", false, chkavKeepmeloggedin_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(chkavKeepmeloggedin.Visible), 5, 0), true);
            chkavRememberme.Visible = 1;
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         AV77GXV6 = 1;
         while ( AV77GXV6 <= AV61Errors.Count )
         {
            AV60Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV61Errors.Item(AV77GXV6));
            if ( AV60Error.gxTpr_Code != 13 )
            {
               GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV60Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV60Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
            }
            AV77GXV6 = (int)(AV77GXV6+1);
         }
      }

      protected void wb_table1_50_0L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNoaccount_Internalname, context.GetMessage( "WWP_GAM_DontHaveAccount", ""), "", "", lblNoaccount_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_GAMExampleLogin.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRegisteruser_Internalname, context.GetMessage( "WWP_GAM_CreateOneNow", ""), lblRegisteruser_Link, "", lblRegisteruser_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "DataDescriptionLogin", 0, "", 1, 1, 0, 0, "HLP_GAMExampleLogin.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_50_0L2e( true) ;
         }
         else
         {
            wb_table1_50_0L2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202491315552563", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexamplelogin.js", "?202491315552567", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Mask/jquery.mask.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/BootstrapSelect.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/WorkWithPlusUtilitiesRender.js", "", false, true);
      ...
      protected void sendrow_622( )
      {
         ...
         StyleString = "";
         AV58ImageAuthType_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV58ImageAuthType))&&String.IsNullOrEmpty(StringUtil.RTrim( AV72Imageauthtype_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV58ImageAuthType)));
         sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV58ImageAuthType)) ? AV72Imageauthtype_GXI : context.PathToRelativeUrl( AV58ImageAuthType));
         GridauthtypesRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtavImageauthtype_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)1,(short)1,(string)"",(string)edtavImageauthtype_Tooltiptext,(short)0,(short)-1,(short)0,(string)"",(short)0,(string)"",(short)0,(short)0,(short)5,(string)edtavImageauthtype_Jsonclick,"'"+""+"'"+",false,"+"'"+"EVIMAGEAUTHTYPE.CLICK."+sGXsfl_62_idx+"'",(string)StyleString,(string)ClassString,(string)"",(string)"",(string)"",(string)"",(string)""+TempTags,(string)"",(string)"",(short)1,(bool)AV58ImageAuthType_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
         GridauthtypesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         GridauthtypesRow.AddRenderProperties(GridauthtypesColumn);
      ...
      protected void StartGridControl62( )
      {
         ...
         else
         {
            ...
            GridauthtypesContainer.AddColumnProperties(GridauthtypesColumn);
            GridauthtypesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridauthtypesColumn.AddObjectProperty("Value", context.convertURL( AV58ImageAuthType));
            ...
            GridauthtypesContainer.AddColumnProperties(GridauthtypesColumn);
            GridauthtypesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridauthtypesColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV59TypeAuthType)));
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "GAM_Login", "");
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("FORGOTPASSWORD.CLICK","""{"handler":"E110L1","iparms":[{"av":"AV16IDP_State","fld":"vIDP_STATE"}]""");
         setEventMetadata("FORGOTPASSWORD.CLICK",""","oparms":[{"av":"AV16IDP_State","fld":"vIDP_STATE"}]}""");
         setEventMetadata("'SELECTAUTHENTICATIONTYPE'","""{"handler":"E180L2","iparms":[{"av":"AV26NameAuthType","fld":"vNAMEAUTHTYPE"},{"av":"AV31UserName","fld":"vUSERNAME"},{"av":"AV32UserPassword","fld":"vUSERPASSWORD"}]}""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV58ImageAuthType = "";
         AV72Imageauthtype_GXI = "";
         AV59TypeAuthType = "";
         AV26NameAuthType = "";
         AV28RepositoryGUID = "";
         AV61Errors = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
         ...
         AV62ErrorsLogin = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
         AV66Session = new GeneXus.Programs.genexussecurity.SdtGAMSession(context);
         AV68GAMApplicationCollection = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplication>( context, "GeneXus.Programs.genexussecurity.SdtGAMApplication", "GeneXus.Programs");
         AV69GAMApplicationFilter = new GeneXus.Programs.genexussecurity.SdtGAMApplicationFilter(context);
         AV70GAMApplication = new GeneXus.Programs.genexussecurity.SdtGAMApplication(context);
         AV65Repository = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context);
         AV13GAMRepository = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context);
         AV60Error = new GeneXus.Programs.genexussecurity.SdtGAMError(context);
      ...
      private string AV59TypeAuthType ;
      ...
      private bool AV63isRedirect ;
      private bool AV67SessionValid ;
      private bool AV20isOK ;
      private bool AV19isModeOTP ;
      private bool AV58ImageAuthType_IsBlob ;
      private string AV8AuxUserName ;
      private string AV25LogOnTo ;
      private string AV31UserName ;
      private string AV30URL ;
      private string AV72Imageauthtype_GXI ;
      private string AV58ImageAuthType ;
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError> AV61Errors ;
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError> AV62ErrorsLogin ;
      private GeneXus.Programs.genexussecurity.SdtGAMSession AV66Session ;
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplication> AV68GAMApplicationCollection ;
      private GeneXus.Programs.genexussecurity.SdtGAMApplicationFilter AV69GAMApplicationFilter ;
      private GeneXus.Programs.genexussecurity.SdtGAMApplication AV70GAMApplication ;
      private GeneXus.Programs.genexussecurity.SdtGAMRepository AV65Repository ;
      private GeneXus.Programs.genexussecurity.SdtGAMRepository AV13GAMRepository ;
      private GeneXus.Programs.genexussecurity.SdtGAMError AV60Error ;

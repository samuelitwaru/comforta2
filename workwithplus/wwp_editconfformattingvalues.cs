   ...
   public class wwp_editconfformattingvalues : GXWebComponent
   {
      ...
      protected void WB1H0( )
      {
         ...
         if ( wbEnd == 15 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuseraction1_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(15), 2, 0)+","+"null"+");", "Cancelar", bttBtnuseraction1_Jsonclick, 7, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e111h1_client"+"'", TempTags, "", 2, "HLP_WorkWithPlus/WWP_EditConfFormattingValues.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249126284080", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/wwp_editconfformattingvalues.js", "?20249126284080", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/GridEmpowerer/GridEmpowererRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDS.LOAD","""{"handler":"E151H2","iparms":[{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15}]""");
         ...
         setEventMetadata("'DOUSERACTIONRESET'","""{"handler":"E121H2","iparms":[{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15},{"av":"AV7VarProgramName","fld":"vVARPROGRAMNAME"}]}""");
      ...
      {
         AV6ConfFormattingVariables = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable>( context, "WWPConfFormattingVariable", "Comforta2");

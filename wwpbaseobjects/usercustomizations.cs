...
namespace GeneXus.Programs.wwpbaseobjects {
   public class usercustomizations : GXHttpHandler
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202491315534396", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/usercustomizations.js", "?202491315534396", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VALID_USERCUSTOMIZATIONSKEY","""{"handler":"Valid_Usercustomizationskey","iparms":[{"av":"A90UserCustomizationsId","fld":"USERCUSTOMIZATIONSID"},{"av":"A91UserCustomizationsKey","fld":"USERCUSTOMIZATIONSKEY"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"}]""");
         setEventMetadata("VALID_USERCUSTOMIZATIONSKEY",""","oparms":[{"av":"A92UserCustomizationsValue","fld":"USERCUSTOMIZATIONSVALUE"},{"av":"Gx_mode","fld":"vMODE","pic":"@!"},{"av":"Z90UserCustomizationsId"},{"av":"Z91UserCustomizationsKey"},{"av":"Z92UserCustomizationsValue"},{"ctrl":"BTN_DELETE","prop":"Enabled"},{"ctrl":"BTN_ENTER","prop":"Enabled"}]}""");
         return  ;
      }

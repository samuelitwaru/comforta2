...
namespace GeneXus.Programs {
   public class customercustomizationww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV16FilterFullText, AV24ManageFiltersExecutionStep, AV19ColumnsSelector, AV49Pgmname, AV25TFCustomerCustomizationId, AV26TFCustomerCustomizationId_To, AV27TFCustomerCustomizationBaseColor, AV28TFCustomerCustomizationBaseColor_Sel, AV29TFCustomerCustomizationFontSize, AV48TFCustomerCustomizationFontSize_Sel, AV31TFCustomerId, AV32TFCustomerId_To, AV33TFCustomerName, AV34TFCustomerName_Sel, AV43IsAuthorized_Update, AV45IsAuthorized_Delete, AV46IsAuthorized_CustomerCustomizationBaseColor, AV47IsAuthorized_Insert) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV49Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV49Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "vTFCUSTOMERCUSTOMIZATIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV25TFCustomerCustomizationId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vTFCUSTOMERCUSTOMIZATIONID_TO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV26TFCustomerCustomizationId_To), 4, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, "vTFCUSTOMERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV31TFCustomerId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vTFCUSTOMERID_TO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV32TFCustomerId_To), 4, 0, ".", "")));
      ...
      protected void WB3J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(37), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_CustomerCustomizationWW.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(37), 2, 0)+","+"null"+");", "Select columns", bttBtneditcolumns_Jsonclick, 0, "Select columns", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_CustomerCustomizationWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START3J2( )
      {
         ...
         Form.Meta.addItem("description", " Customer Customization", 0) ;
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              A128CustomerCustomizationId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtCustomerCustomizationId_Internalname), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E173J2( )
      {
         ...
         Form.Caption = " Customer Customization";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024912632564", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customercustomizationww.js", "?2024912632565", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void StartGridControl37( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Customization Id") ;
            ...
            context.SendWebValue( "Customization Logo") ;
            context.WriteHtmlTextNl( "</th>") ;
            ...
            context.SendWebValue( "Customization Favicon") ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV49Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV25TFCustomerCustomizationId","fld":"vTFCUSTOMERCUSTOMIZATIONID","pic":"ZZZ9"},{"av":"AV26TFCustomerCustomizationId_To","fld":"vTFCUSTOMERCUSTOMIZATIONID_TO","pic":"ZZZ9"},{"av":"AV27TFCustomerCustomizationBaseColor","fld":"vTFCUSTOMERCUSTOMIZATIONBASECOLOR"},{"av":"AV28TFCustomerCustomizationBaseColor_Sel","fld":"vTFCUSTOMERCUSTOMIZATIONBASECOLOR_SEL"},{"av":"AV29TFCustomerCustomizationFontSize","fld":"vTFCUSTOMERCUSTOMIZATIONFONTSIZE"},{"av":"AV48TFCustomerCustomizationFontSize_Sel","fld":"vTFCUSTOMERCUSTOMIZATIONFONTSIZE_SEL"},{"av":"AV31TFCustomerId","fld":"vTFCUSTOMERID","pic":"ZZZ9"},{"av":"AV32TFCustomerId_To","fld":"vTFCUSTOMERID_TO","pic":"ZZZ9"},{"av":"AV33TFCustomerName","fld":"vTFCUSTOMERNAME"},{"av":"AV34TFCustomerName_Sel","fld":"vTFCUSTOMERNAME_SEL"},{"av":"AV43IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV45IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV46IsAuthorized_CustomerCustomizationBaseColor","fld":"vISAUTHORIZED_CUSTOMERCUSTOMIZATIONBASECOLOR","hsh":true},{"av":"AV47IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtCustomerCustomizationId_Visible","ctrl":"CUSTOMERCUSTOMIZATIONID","prop":"Visible"},{"av":"edtCustomerCustomizationLogo_Visible","ctrl":"CUSTOMERCUSTOMIZATIONLOGO","prop":"Visible"},{"av":"edtCustomerCustomizationFavicon_Visible","ctrl":"CUSTOMERCUSTOMIZATIONFAVICON","prop":"Visible"},{"av":"edtCustomerCustomizationBaseColor_Visible","ctrl":"CUSTOMERCUSTOMIZATIONBASECOLOR","prop":"Visible"},{"av":"edtCustomerCustomizationFontSize_Visible","ctrl":"CUSTOMERCUSTOMIZATIONFONTSIZE","prop":"Visible"},{"av":"edtCustomerId_Visible","ctrl":"CUSTOMERID","prop":"Visible"},{"av":"edtCustomerName_Visible","ctrl":"CUSTOMERNAME","prop":"Visible"},{"av":"AV39GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV40GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV41GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV43IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV45IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV47IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV22ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E123J2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV49Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV25TFCustomerCustomizationId","fld":"vTFCUSTOMERCUSTOMIZATIONID","pic":"ZZZ9"},{"av":"AV26TFCustomerCustomizationId_To","fld":"vTFCUSTOMERCUSTOMIZATIONID_TO","pic":"ZZZ9"},{"av":"AV27TFCustomerCustomizationBaseColor","fld":"vTFCUSTOMERCUSTOMIZATIONBASECOLOR"},{"av":"AV28TFCustomerCustomizationBaseColor_Sel","fld":"vTFCUSTOMERCUSTOMIZATIONBASECOLOR_SEL"},{"av":"AV29TFCustomerCustomizationFontSize","fld":"vTFCUSTOMERCUSTOMIZATIONFONTSIZE"},{"av":"AV48TFCustomerCustomizationFontSize_Sel","fld":"vTFCUSTOMERCUSTOMIZATIONFONTSIZE_SEL"},{"av":"AV31TFCustomerId","fld":"vTFCUSTOMERID","pic":"ZZZ9"},{"av":"AV32TFCustomerId_To","fld":"vTFCUSTOMERID_TO","pic":"ZZZ9"},{"av":"AV33TFCustomerName","fld":"vTFCUSTOMERNAME"},{"av":"AV34TFCustomerName_Sel","fld":"vTFCUSTOMERNAME_SEL"},{"av":"AV43IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV45IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV46IsAuthorized_CustomerCustomizationBaseColor","fld":"vISAUTHORIZED_CUSTOMERCUSTOMIZATIONBASECOLOR","hsh":true},{"av":"AV47IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         ...
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",""","oparms":[{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV25TFCustomerCustomizationId","fld":"vTFCUSTOMERCUSTOMIZATIONID","pic":"ZZZ9"},{"av":"AV26TFCustomerCustomizationId_To","fld":"vTFCUSTOMERCUSTOMIZATIONID_TO","pic":"ZZZ9"},{"av":"AV27TFCustomerCustomizationBaseColor","fld":"vTFCUSTOMERCUSTOMIZATIONBASECOLOR"},{"av":"AV28TFCustomerCustomizationBaseColor_Sel","fld":"vTFCUSTOMERCUSTOMIZATIONBASECOLOR_SEL"},{"av":"AV29TFCustomerCustomizationFontSize","fld":"vTFCUSTOMERCUSTOMIZATIONFONTSIZE"},{"av":"AV48TFCustomerCustomizationFontSize_Sel","fld":"vTFCUSTOMERCUSTOMIZATIONFONTSIZE_SEL"},{"av":"AV31TFCustomerId","fld":"vTFCUSTOMERID","pic":"ZZZ9"},{"av":"AV32TFCustomerId_To","fld":"vTFCUSTOMERID_TO","pic":"ZZZ9"},{"av":"AV33TFCustomerName","fld":"vTFCUSTOMERNAME"},{"av":"AV34TFCustomerName_Sel","fld":"vTFCUSTOMERNAME_SEL"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E193J2","iparms":[{"av":"AV43IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A128CustomerCustomizationId","fld":"CUSTOMERCUSTOMIZATIONID","pic":"ZZZ9","hsh":true},{"av":"AV45IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV46IsAuthorized_CustomerCustomizationBaseColor","fld":"vISAUTHORIZED_CUSTOMERCUSTOMIZATIONBASECOLOR","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV42Update","fld":"vUPDATE"},{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"AV44Delete","fld":"vDELETE"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtCustomerCustomizationBaseColor_Link","ctrl":"CUSTOMERCUSTOMIZATIONBASECOLOR","prop":"Link"}]}""");
         ...
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",""","oparms":[{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"edtCustomerCustomizationId_Visible","ctrl":"CUSTOMERCUSTOMIZATIONID","prop":"Visible"},{"av":"edtCustomerCustomizationLogo_Visible","ctrl":"CUSTOMERCUSTOMIZATIONLOGO","prop":"Visible"},{"av":"edtCustomerCustomizationFavicon_Visible","ctrl":"CUSTOMERCUSTOMIZATIONFAVICON","prop":"Visible"},{"av":"edtCustomerCustomizationBaseColor_Visible","ctrl":"CUSTOMERCUSTOMIZATIONBASECOLOR","prop":"Visible"},{"av":"edtCustomerCustomizationFontSize_Visible","ctrl":"CUSTOMERCUSTOMIZATIONFONTSIZE","prop":"Visible"},{"av":"edtCustomerId_Visible","ctrl":"CUSTOMERID","prop":"Visible"},{"av":"edtCustomerName_Visible","ctrl":"CUSTOMERNAME","prop":"Visible"},{"av":"AV39GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV40GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV41GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV43IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV45IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV47IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV22ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV25TFCustomerCustomizationId","fld":"vTFCUSTOMERCUSTOMIZATIONID","pic":"ZZZ9"},{"av":"AV26TFCustomerCustomizationId_To","fld":"vTFCUSTOMERCUSTOMIZATIONID_TO","pic":"ZZZ9"},{"av":"AV27TFCustomerCustomizationBaseColor","fld":"vTFCUSTOMERCUSTOMIZATIONBASECOLOR"},{"av":"AV28TFCustomerCustomizationBaseColor_Sel","fld":"vTFCUSTOMERCUSTOMIZATIONBASECOLOR_SEL"},{"av":"AV29TFCustomerCustomizationFontSize","fld":"vTFCUSTOMERCUSTOMIZATIONFONTSIZE"},{"av":"AV48TFCustomerCustomizationFontSize_Sel","fld":"vTFCUSTOMERCUSTOMIZATIONFONTSIZE_SEL"},{"av":"AV31TFCustomerId","fld":"vTFCUSTOMERID","pic":"ZZZ9"},{"av":"AV32TFCustomerId_To","fld":"vTFCUSTOMERID_TO","pic":"ZZZ9"},{"av":"AV33TFCustomerName","fld":"vTFCUSTOMERNAME"},{"av":"AV34TFCustomerName_Sel","fld":"vTFCUSTOMERNAME_SEL"},{"av":"Ddo_grid_Selectedvalue_set","ctrl":"DDO_GRID","prop":"SelectedValue_set"},{"av":"Ddo_grid_Filteredtext_set","ctrl":"DDO_GRID","prop":"FilteredText_set"},{"av":"Ddo_grid_Filteredtextto_set","ctrl":"DDO_GRID","prop":"FilteredTextTo_set"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtCustomerCustomizationId_Visible","ctrl":"CUSTOMERCUSTOMIZATIONID","prop":"Visible"},{"av":"edtCustomerCustomizationLogo_Visible","ctrl":"CUSTOMERCUSTOMIZATIONLOGO","prop":"Visible"},{"av":"edtCustomerCustomizationFavicon_Visible","ctrl":"CUSTOMERCUSTOMIZATIONFAVICON","prop":"Visible"},{"av":"edtCustomerCustomizationBaseColor_Visible","ctrl":"CUSTOMERCUSTOMIZATIONBASECOLOR","prop":"Visible"},{"av":"edtCustomerCustomizationFontSize_Visible","ctrl":"CUSTOMERCUSTOMIZATIONFONTSIZE","prop":"Visible"},{"av":"edtCustomerId_Visible","ctrl":"CUSTOMERID","prop":"Visible"},{"av":"edtCustomerName_Visible","ctrl":"CUSTOMERNAME","prop":"Visible"},{"av":"AV39GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV40GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV41GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV43IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV45IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV47IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV22ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E163J2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV49Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV25TFCustomerCustomizationId","fld":"vTFCUSTOMERCUSTOMIZATIONID","pic":"ZZZ9"},{"av":"AV26TFCustomerCustomizationId_To","fld":"vTFCUSTOMERCUSTOMIZATIONID_TO","pic":"ZZZ9"},{"av":"AV27TFCustomerCustomizationBaseColor","fld":"vTFCUSTOMERCUSTOMIZATIONBASECOLOR"},{"av":"AV28TFCustomerCustomizationBaseColor_Sel","fld":"vTFCUSTOMERCUSTOMIZATIONBASECOLOR_SEL"},{"av":"AV29TFCustomerCustomizationFontSize","fld":"vTFCUSTOMERCUSTOMIZATIONFONTSIZE"},{"av":"AV48TFCustomerCustomizationFontSize_Sel","fld":"vTFCUSTOMERCUSTOMIZATIONFONTSIZE_SEL"},{"av":"AV31TFCustomerId","fld":"vTFCUSTOMERID","pic":"ZZZ9"},{"av":"AV32TFCustomerId_To","fld":"vTFCUSTOMERID_TO","pic":"ZZZ9"},{"av":"AV33TFCustomerName","fld":"vTFCUSTOMERNAME"},{"av":"AV34TFCustomerName_Sel","fld":"vTFCUSTOMERNAME_SEL"},{"av":"AV43IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV45IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV46IsAuthorized_CustomerCustomizationBaseColor","fld":"vISAUTHORIZED_CUSTOMERCUSTOMIZATIONBASECOLOR","hsh":true},{"av":"AV47IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A128CustomerCustomizationId","fld":"CUSTOMERCUSTOMIZATIONID","pic":"ZZZ9","hsh":true}]""");
         setEventMetadata("'DOINSERT'",""","oparms":[{"av":"AV24ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV19ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtCustomerCustomizationId_Visible","ctrl":"CUSTOMERCUSTOMIZATIONID","prop":"Visible"},{"av":"edtCustomerCustomizationLogo_Visible","ctrl":"CUSTOMERCUSTOMIZATIONLOGO","prop":"Visible"},{"av":"edtCustomerCustomizationFavicon_Visible","ctrl":"CUSTOMERCUSTOMIZATIONFAVICON","prop":"Visible"},{"av":"edtCustomerCustomizationBaseColor_Visible","ctrl":"CUSTOMERCUSTOMIZATIONBASECOLOR","prop":"Visible"},{"av":"edtCustomerCustomizationFontSize_Visible","ctrl":"CUSTOMERCUSTOMIZATIONFONTSIZE","prop":"Visible"},{"av":"edtCustomerId_Visible","ctrl":"CUSTOMERID","prop":"Visible"},{"av":"edtCustomerName_Visible","ctrl":"CUSTOMERNAME","prop":"Visible"},{"av":"AV39GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV40GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV41GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV43IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV45IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV47IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV22ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");

...
namespace GeneXus.Programs {
   public class home : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202491315543822", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("home.js", "?202491315543822", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDHOMEMODULESSDTS.LOAD","""{"handler":"E120Z2","iparms":[{"av":"AV6HomeModulesSDT","fld":"vHOMEMODULESSDT","hsh":true}]""");
      ...
      public override void initialize( )
      {
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         AV6HomeModulesSDT = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem>( context, "HomeModulesSDTItem", "Comforta2");
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
         ...
         WebComp_Layoutprogressbarwc_Component = "";
         WebComp_Layoutprogresscirclewc_Component = "";
         GXt_objcol_SdtHomeModulesSDT_HomeModulesSDTItem1 = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem>( context, "HomeModulesSDTItem", "Comforta2");

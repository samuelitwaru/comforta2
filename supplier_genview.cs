...
namespace GeneXus.Programs {
   public class supplier_genview : GXDataArea
   {
      ...
      {
         GxWebStd.gx_hidden_field( context, "vSUPPLIER_GENID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10Supplier_GenId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vSUPPLIER_GENID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10Supplier_GenId), "ZZZ9"), context));
      ...
      protected void WB200( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Back to General Suppliers", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Supplier_GenView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProductservice_title_Internalname, "Product Service", "", "", lblProductservice_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Supplier_GenView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSupplier_gencustomer_title_Internalname, "Customer", "", "", lblSupplier_gencustomer_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Supplier_GenView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
      ...
      protected void START202( )
      {
         ...
         Form.Meta.addItem("description", "Supplier_Gen View", 0) ;
         context.wjLoc = "";
      ...
      protected void STRUP200( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10Supplier_GenId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vSUPPLIER_GENID"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249126312937", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("supplier_genview.js", "?20249126312938", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Supplier_Gen View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV10Supplier_GenId","fld":"vSUPPLIER_GENID","pic":"ZZZ9","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]}""");
         return  ;
      }
